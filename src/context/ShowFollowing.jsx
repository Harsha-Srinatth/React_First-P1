            ...
            try{
                ...
                if(res && res.data){
                    ...
                    if(Array.isArray(res.data)){
                        ...
                        console.log("Setting following from array response:", res.data);
                    }else if( res.data.following && Array.isArray(res.data.following)){
                        setFollowing(res.data.following);
                        console.log("Setting following from res.data.following:", res.data.following);
                    }else{
      ...
      <div className='space-y-2'>
        {filteredFollowing.length > 0 ? (
          filteredFollowing.map(user => {
            console.log('Following object:', user);
            return (
              <div 
                key={user.userId} 
