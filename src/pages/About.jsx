...
const About = () => {
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-black via-zinc-900 to-blue-950 flex flex-col items-center justify-start py-8 px-4 lg:px-8 overflow-y-auto pt-20 md:pt-8 pb-24 md:pb-8">
